...
describe("the JavaScript language", function () {
    ...
    describe("has different types and operators that", function () {
        ...
        it("considers nulls to be falsy", function () {
            ...
            expect(result == false).toBeTruthy();// Truthy or Falsy         // ===  es condicional estricto
            expect(null === false).toBeFalsy();// Truthy or Falsy
            expect(null == false).toBeFalsy();// Truthy or falsy          //Si una variable es null se evalua como falsy
        });
        ...
        it("knows the type of a function", function () {
            ...
            expect(typeof(xxx)).toBe('undefined');   // En JS lo que no está definido es undefined
        });
        ...
        it("concatenate arrays - well, kind of", function () {
            var a = [1, 2, 3];
            var b = [4, 5, 6];                  // Dos arrays concadenados (+) me devuelven un string y los elementos sin espacios
        ...
        it("can't compare arrays", function () {
            var a = [1, 2, 3];
            var b = [1, 2, 3];
                                                                //No se pueden comparar arrays, siempre serán falsos.
            expect(a == b).toBeFalsy();  // Truthy or Falsy     // Hay que comparar un elemento del array con un elemento del otro
    ...
    describe("considers functions as first class citizens", function () {
        ...
        it("can declare named functions", function () {
            function example() {
                return 'some example';
                                                        ...
                                                        // Se espera que la fuction sea igual a su valor de retorno
        ...
        it("can declare anonymous functions", function () {
            ...
            expect(typeof(someVar)).toBe('function');           // El typeof te devuelve un string que el tipo de la clase
        ...
        it("may return arrays that contains functions and so on", function () {
            function example() {
                return [
                    function() {
                        return [1, 10];                                         //Funciones pueden devolver arrays que a su vez
                    }                                                           // contengan functions
                ];
            };
        ...
        it("anonymous functions are anonymous", function () {
            ...
            expect(typeof(z)).toEqual('undefined');                 //Es anónimo llamar a la función dentro de una variable
            expect(x()).toEqual(1);
        });
        ...
        it("may return a function as the result of invoking a function", function () {
            ...
            function example() {
                return add;                             //El add va a sumar los dos argumentos
            }
        ...
        it("can return closures as a function result", function () {
            ...
            expect(f(3)).toBe(8);   //plus(5)(3)
            expect(f(3)).toBe(plus(5)(3)); 
        });
        ...
        it("can have functions that receive other functions as arguments", function () {
            ...
            function multiply(a, b) {
                return a * b;
                                                    ...
                                                    //Se crea una función 'madre' que permite utilizar otras para tratar los argumentos
            function example(arg) {
                return arg(3, 2) + 1;
            }

            expect(example(add)).toEqual(6);
            expect(example(multiply)).toEqual(7);
        });
        ...
        it("can invoke functions indirectly using the special 'apply'", function () {
            ...
            var arg = [1,1];
            expect(f.apply(f, arg)).toEqual(2);
        });
    ...
    describe("has multiple ways to define and create objects", function () {
        ...
        it("may define complex objects", function () {
            ...
            expect(user.friends[1].name).toEqual('triki');
        });
        ...
        it("may create objects also with the module pattern", function () {
            function createObject(initialScore, initialColor) {
                var initialPoints = initialScore;
        ...
        it("can have have methods in the prototype", function () {
            ...
            expect(obj.theName).toBe(new Obj().theName);     //DUDA prototype deja un valor por defecto ?? 
